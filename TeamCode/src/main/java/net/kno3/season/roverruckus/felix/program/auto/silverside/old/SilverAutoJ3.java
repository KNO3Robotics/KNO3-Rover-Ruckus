...
@Autonomous(name = "FELIX SILVER AUTO J3", group = "Auto")
@Disabled
public class SilverAutoJ3 extends FelixAuto {
    ...
    public void main(){
        ...
        intake.intakeSlides.setTargetPosition(intake.intakeSlides.getCurrentPosition() - 800);
        ...
        intake.intakeSlides.setTargetPosition(intake.intakeSlides.getCurrentPosition() - 400);
        intake.intakeSlides.setPower(-.5);
        while(opModeIsActive() && intake.intakeSlides.isBusy()) {
            waitFor(0.05);
        }
